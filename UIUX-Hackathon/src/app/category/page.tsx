...
import Card from './components/casual/Cards';
    ...
    return (
        <div className='w-full mt-6 flex flex-col justify-center items-center'>
            ...
            <div className='flex gap-[20px] mt-6 justify-center'>
                ...
                <Filter />
                {/* heading */}
                <div className='flex flex-col justify-center items-center w-full md:max-w-[950px] px-[16px] md:max-px-[100px]'>
                    <div className="flex flex-row gap-[8px] lg:justify-between w-full">
                        <div className="flex items-center justify-between">
                            <h1 className="font-bold text-2xl md:text-[32px] tracking-tighter">Casual</h1>
                        </div>
