...
export default function Footer() {
  ...
  return (
    <div className="flex flex-col rounded-none mt-[-60px] md:mt-0">
      {/* newsletter */}
      <div className="relative top-[158px] md:top-[90px] flex overflow-hidden z-10 flex-wrap gap-10 justify-between items-center self-center mx-[16px] px-16 py-9 w-[91.795vw] bg-black rounded-3xl max-w-[1240px] max-md:px-5 ">
      ...
      <div className="flex flex-col items-center px-20 pt-36 pb-20 w-full bg-zinc-100 max-md:px-5 max-md:pt-24 max-md:max-w-full">
        <div className="flex flex-wrap gap-10 justify-between pt-[88.58px] md:pt-0 items-start w-full max-w-[1240px] max-md:max-w-full">
          <div className="flex flex-col min-w-[240px] w-[357px] md:w-[248px] gap-[35px] md:gap-[20px]">
            <div className="flex flex-col max-w-full w-[357px] md:w-[248px]">
              <div className="text-4xl font-bold text-black">SHOP.CO</div>
              <div className="mt-6 text-sm leading-6 text-black text-opacity-60">
        ...
        <div className="flex flex-wrap justify-center sm:justify-between gap-4 mt-5 w-full max-w-[1240px] max-md:max-w-full">
          <div className="my-auto text-sm text-right text-black text-opacity-60">
            Shop.co © 2000-2023, All Rights Reserved
          </div>
          {/* SocialIcons  */}
          <div className='flex w-[240px] md:w-[281px]'>
            {/* visa */}
